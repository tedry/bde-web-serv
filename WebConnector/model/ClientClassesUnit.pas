...
type
  TServerMethods1Client = class(TDSAdminClient)
    ...
    public
      ...
      function RegisterCheck(clientID: string; callbackID: string; sPrefetchList: string): string;
      function FreshenCache(clientID: string; callbackID: string; sPrefetchList: string): string;
...
// -------------------------------------------------------------------------------------------------------------------------------
function TServerMethods1Client.RegisterCheck(clientID: string; callbackID: string; sPrefetchList: string): string;
begin
  ...
  FRegisterCheckCommand.Parameters[2].Value.SetWideString(sPrefetchList);
  FRegisterCheckCommand.ExecuteUpdate;
  Result:= FRegisterCheckCommand.Parameters[3].Value.GetWideString;
end;

// -------------------------------------------------------------------------------------------------------------------------------
function TServerMethods1Client.FreshenCache(clientID: string; callbackID: string; sPrefetchList: string): string;
begin
  if FFreshenCache = nil then
    begin
      FFreshenCache            := FDBXConnection.CreateCommand;
      FFreshenCache.CommandType:= TDBXCommandTypes.DSServerMethod;
      FFreshenCache.Text       := 'TServerMethods1.FreshenCache';
      FFreshenCache.Prepare;
    end;
  FFreshenCache.Parameters[0].Value.SetWideString(clientID);
  FFreshenCache.Parameters[1].Value.SetWideString(callbackID);
  FFreshenCache.Parameters[2].Value.SetWideString(sPrefetchList);
  FFreshenCache.ExecuteUpdate;
  Result:= FFreshenCache.Parameters[3].Value.GetWideString;
end;
